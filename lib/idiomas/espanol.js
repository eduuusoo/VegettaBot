...
//AVISOS DE MENSAJE
const smsAvisoRG = () => { return `VEGETTA BOT\n\n` } 
...
const smsAvisoEG = () => { return `VEGETTA BOT\n\n` }
...
const smsLista1 = () => { return `🌟 INFORMACIÓN VEGETTA BOT🌟`}
...
//_allantilink.js
const smsTextoYT = () => { return ' VEGETTA BOT '} 
...
const smsModP2 = () => { return `Habilitar función para que todos puedan usar VEGETTA BOT`}
...
» https://www.instagram.com/yeray_bot_md`} 
...
//grupo-tagall.js
const smstagaa = () => { return `*AQUAMAN BOT LOS INVOCA⚡*
_LEVANTENSEN_ 🔱`}
